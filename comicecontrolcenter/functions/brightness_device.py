...
class BrightnessInformation():
    ...
    def __init__(self):
        ...
        if self.device is not None:
            command2 = """cat /sys/class/backlight/intel_backlight/max_brightness""".format(self.device)
            ...
            command3 = """cat /sys/class/backlight/intel_backlight/brightness""".format(self.device)
